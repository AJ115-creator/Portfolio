              ...
              <div className="flex space-x-4">
                {socialLinks.map((social, index) => (
                  <motion.a
                    ...
                    className="w-10 h-10 bg-gray-800 hover:bg-primary-600 rounded-full flex items-center justify-center transition-colors duration-300 group"
            ...
            >
              ...
              <div className="space-y-3">
                <div className="flex items-center text-gray-300 text-sm">
                  ...
                  <a href="mailto:ayushjha115.aj@gmail.com" className="hover:text-primary-400 transition-colors">
                    ayushjha115.aj@gmail.com
                  </a>
                </div>
                <div className="flex items-center text-gray-300 text-sm">
                  <svg className="w-4 h-4 mr-3 text-primary-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <a href="tel:+917905325033" className="hover:text-primary-400 transition-colors">
                    +91 7905325033
                  </a>
                </div>
                <div className="flex items-center text-gray-300 text-sm">
